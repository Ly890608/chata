...
template <typename T>
constexpr T gTwoInvSqrtPI = static_cast<T>(1.12837916709551257390); // 2/sqrt(pi)
template <typename T>
...
template <typename T>
constexpr T gDegreesToRadians = static_cast<T>(3.14159265358979323846) / static_cast<T>(180.0);
template <typename T>
constexpr T gRadiansToDegrees = static_cast<T>(180.0) / static_cast<T>(3.14159265358979323846);
} // namespace chata
